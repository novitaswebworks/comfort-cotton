...
export default function FloatingWhatsApp() {
  ...
  return (
    <button
      onClick={handleChat}
      className="fixed bottom-24 right-6 md:bottom-8 md:right-8 z-50 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:scale-110 hover:bg-green-600 transition-all duration-300 group flex items-center gap-0 overflow-hidden"
